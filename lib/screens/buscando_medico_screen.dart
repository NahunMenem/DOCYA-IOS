...
class BuscandoMedicoScreen extends StatefulWidget {
  ...
  final String pacienteUuid; // 👈 agregado
  ...
  const BuscandoMedicoScreen({
    ...
    required this.pacienteUuid, // 👈 agregado
  });
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    "Buscando un profesional disponible...",
                    style: TextStyle(
                      fontSize: 18,
